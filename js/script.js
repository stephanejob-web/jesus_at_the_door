...
const translations = {
    fr: {
        ...
        questions: {
            q1_image: "Avez-vous déjà vu cette image ?",
            q1_pray: "Priez-vous ?",
            ...
            q2: "Voici, Jésus frappe à la porte de votre cœur. La poignée est à l'intérieur, vous êtes la seule personne à pouvoir Le laisser entrer.",
            q4: "Imaginez porter sur vos épaules un sac contenant tous vos péchés. Pas seulement les \"gros\" péchés, mais aussi les petits mensonges, les mauvaises pensées, les paroles blessantes... Ce poids, c'est ce qui brise la relation avec Dieu.",
            ...
            q5: "Si vous deviez un million d'Euros à la banque et que je vous donne un chèque de ce montant et que vous le remettiez à la banque, qu'adviendrait-il de votre dette ?",
            q5_question: "Votre dette serait effacée ?",
            q6: "C'est ce que Jésus a fait lorsqu'Il est mort sur la croix, {name}.\n\nIl vous a fait un chèque signé de Son sang - avec votre nom « {name} » écrit dessus.\n\nIl est ressuscité, et aujourd'hui, Il se tient à la porte de votre cœur, désirant que vous l'encaissiez.",
            q7: "Si Jésus était ici en ce moment, Le laisseriez-vous entrer ?",
            q8: "Pouvez-vous voir le vent ? Non, mais vous pouvez le sentir, n'est-ce pas ? Comme le vent, Jésus est ici en ce moment.",
            q8_question: "Puis-je prier pour que vous sentiez Sa présence ?",
            ...
            q9_felt: "Avez-vous ressenti la présence de Dieu ?",
            q10_follow: "En ce moment, vous êtes sur un chemin de vie sans Jésus. Vous devez vous détourner de votre péché, changer de direction et Le suivre.",
            q10_question: "Voulez-vous Le suivre ?",
            q11_faith: "Par la foi, croyez-vous que Jésus est ici en ce moment ?",
            q_repeat_prayer: "Si tu veux vraiment suivre Jésus, répète cette prière avec moi :\n\nJésus, pardonne-moi mes péchés.\nJ'ouvre la porte de mon cœur.\nJe te fais Seigneur de ma vie.\nRemplis-moi de ton Esprit.\n\nAmen.",
            q_repeat_prayer_question: "As-tu répété cette prière ?",
            final_reflection: "Merci pour ton honnêteté, {name}.\n\nJésus respecte ton choix et continue de t'aimer.\n\n« Car Dieu a tant aimé le monde qu'il a donné son Fils unique. »\n— Jean 3:16\n\nLa porte reste ouverte. Toujours.\nTu peux revenir quand tu veux.\n\nQue Dieu te bénisse.",
        ...
        finalScreen: {
            title: "Bienvenue dans ta nouvelle vie avec Jésus !",
            prayerText: "Jésus, pardonne-moi mes péchés. J'ouvre la porte de mon cœur. Je te fais Seigneur de ma vie. Remplis-moi de ton Esprit.",
            amen: "Amen.",
            welcomeMessage: "Aujourd'hui, tu as ouvert ton cœur ❤️ à Jésus-Christ. C'est la plus belle décision de ta vie ! Une nouvelle aventure commence pour toi.",
            journeyTitle: "🚶‍♂️ Marcher avec Jésus, chaque jour",
            journeyText: "Dire \"oui\" à Jésus, c'est un bon départ. Mais l'essentiel, c'est de continuer chaque jour. Jésus t'appelle à une relation vivante avec Lui – pas juste un moment fort, mais une vie entière à Ses côtés.",
            teachingTitle: "📖 Ce que Jésus nous enseigne",
            teachingText: "Jésus a dit que la Parole de Dieu est comme une graine, et ton cœur est comme un sol. Il y a 4 types de cœurs. Aujourd'hui, lequel est le tien ?",
            heart1Title: "1. Le bord du chemin",
            heart1Desc: "Tu entends le message, mais tu ne fais pas attention. Ton cœur est fermé.",
            heart1Consequence: "👉 Le diable t'enlève ce que Dieu voulait te donner.",
            heart2Title: "2. Le sol pierreux",
            heart2Desc: "Tu écoutes avec joie, mais ça ne va pas profond.",
            heart2Consequence: "👉 Dès que ça devient dur, tu abandonnes. Tu n'es pas vraiment décidé à suivre Jésus.",
            heart3Title: "3. Les ronces",
            heart3Desc: "Tu veux croire, mais tu es étouffé par les soucis.",
            heart3Consequence: "👉 Tu es stressé, inquiet, submergé par les problèmes, l'argent ou des blessures du passé… La Parole entre, mais elle ne reste pas. Elle est étouffée par tes préoccupations, et ne peut pas produire de changement en toi.",
            heart4Title: "4. La bonne terre",
            heart4Desc: "Tu entends, tu ouvres ton cœur, tu te repens, et tu laisses Jésus te transformer.",
            heart4Consequence: "👉 Ta vie change. Tu vis pour Dieu. Et tu portes du fruit.",
            encouragementTitle: "✨ Mon encouragement pour toi",
            encouragementText: "Ne laisse rien voler ce que Dieu a commencé en toi ! Reste connecté à Jésus en :",
            encouragement1: "Lui parlant chaque jour",
            encouragement2: "Lisant la Bible",
            encouragement3: "Venant à l'église",
            bibleQuote: "Celui qui a commencé en vous cette bonne œuvre la rendra parfaite.",
            bibleQuoteRef: "— Philippiens 1:6",
            bookTitle: "🎁 Découvre \"Suivre Jésus\"",
    ...
    en: {
        ...
        finalScreen: {
            ...
            amen: "Amen.",
            welcomeMessage: "Today, you have opened your heart ❤️ to Jesus Christ. This is the best decision of your life! A new adventure begins for you.",
            journeyTitle: "🚶‍♂️ Walking with Jesus, every day",
            journeyText: "Saying \"yes\" to Jesus is a good start. But the essential thing is to continue every day. Jesus calls you to a living relationship with Him – not just a strong moment, but a lifetime by His side.",
            teachingTitle: "📖 What Jesus teaches us",
            ...
            heart1Consequence: "👉 The devil takes away what God wanted to give you.",
            heart2Title: "2. The rocky soil",
            heart2Desc: "You listen with joy, but it doesn't go deep.",
            heart2Consequence: "👉 As soon as it gets hard, you give up. You're not really decided to follow Jesus.",
            heart3Title: "3. The thorns",
            heart3Desc: "You want to believe, but you are choked by worries.",
            heart3Consequence: "👉 You are stressed, anxious, overwhelmed by problems, money or past hurts... The Word enters, but it doesn't stay. It is choked by your concerns, and cannot produce change in you.",
            heart4Title: "4. The good soil",
            heart4Desc: "You hear, you open your heart, you repent, and you let Jesus transform you.",
            heart4Consequence: "👉 Your life changes. You live for God. And you bear fruit.",
            encouragementTitle: "✨ My encouragement for you",
            ...
            bibleQuoteRef: "— Philippians 1:6",
            bookTitle: "🎁 Discover \"Following Jesus\"",
...
function updateHomeScreen() {
    ...
    welcomeText.innerHTML = `${t('home.verse')}<br><span style="font-size: 0.7em; font-style: italic; opacity: 0.9;">— ${t('home.reference')}</span>`;
